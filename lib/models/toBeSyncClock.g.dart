...
part of 'toBeSyncClock.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ToBeSyncClockAdapter extends TypeAdapter<ToBeSyncClock> {
  @override
  final int typeId = 4;

  @override
  ToBeSyncClock read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ToBeSyncClock(
      ...
      clock_type: fields[32] == null ? '' : fields[32] as String,
      sale_type: fields[33] == null ? '' : fields[33] as String,
      sync_failed: fields[34] == null ? '' : fields[34] as String,
      is_verify: fields[35] == null ? '' : fields[35] as String,
    );
  }
  ...
  void write(BinaryWriter writer, ToBeSyncClock obj) {
    writer
      ...
      ..writeByte(32)
      ..write(obj.clock_type)
      ..writeByte(33)
      ..write(obj.sale_type)
      ..writeByte(34)
      ..write(obj.sync_failed)
      ..writeByte(35)
      ..write(obj.is_verify);
  }
